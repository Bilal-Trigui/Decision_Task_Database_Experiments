#!/usr/bin/env python3
"""Reroll this folder's instilled_weights.csv under the A3 rule. See data/a3/README.md.
...
experiment; the interaction rule supplies whatever is specific to this one. Run it with no arguments.
    ...
    python data/a3/a3_weight_generator.py
    python data/a3/a3_weight_generator.py --seed 7 --rebuild
"""
import sys
